...
class RestEndpointIntegrationTest {
    ...
    void testEndpointsReturnValidHttpResponses() {
        String[] endpoints = {
            "/api/v1/compute/instances/account/" + testAccountId,
            "/api/v1/storage/buckets/user/" + testUserId,
            "/api/v1/lambda?userId=" + testUserId,
            "/api/v1/rds/instances/user/" + testUserId,
            "/api/v1/iam/users",
            "/api/v1/billing/summary/" + testAccountId,
            "/api/v1/monitoring/audit/recent",
